...
/******************************************************
 *** This file is taken from previous stable project
 *** It requires in GSM-GPRS communication module. 
 *****************************************************/
