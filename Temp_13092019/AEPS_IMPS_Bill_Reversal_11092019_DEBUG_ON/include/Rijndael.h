...
public:
    ...
    int Rijndeal_256_encryption_process(char *encryption_key,char *input_data_buffer,int input_length,char *output_data_buffer,int *output_data_length,int *padded_bytes);

    int Rijndeal_256_decryption_process(char *encryption_key,char *input_data_buffer,int input_length,char *output_data_buffer,int *output_data_length,int padded_bytes);
