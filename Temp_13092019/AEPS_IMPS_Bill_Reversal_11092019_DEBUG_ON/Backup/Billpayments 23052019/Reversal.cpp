...
int FPB::Reversal_Refund_Request()
{
    ...
    memcpy(firefund.Ref_ABappId_req,CLIENT_ID,9);
   ...
   // memcpy(firefund.Ref_amount_req,"175.0",5);
    ...
    memcpy(firefund.RefsupportData_LKNST,"5",1);
    ...
    qDebug()<<"firefund.Ref_supportdata2"<<firefund.Ref_supportdata2;
    qDebug()<<"firefund.Ref_supportdata2"<<firefund.Ref_supportdata2;
    qDebug()<<"firefund.Ref_supportdata2"<<firefund.Ref_supportdata2;
...
int FPB::Reversal_Refire_Request()
{
   char szDate[16], szTime[16];
    ...
    memcpy(firefund.Ref_txnType_req, Flag_Transaction_Type, strlen(Flag_Transaction_Type));
    memcpy(firefund.Ref_impsserviceflag_req,"Y",1);
